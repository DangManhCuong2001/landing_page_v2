...
export default function AssetFlow() {
    return (
        <div className="asset-flow" style={{ marginTop: '150px', minHeight: '500px' }}>
            ...
            <div className="grid-view-1 " style={{ marginTop: '40px', gap: '20px' }}>
                <div className="grid-left">
                    <div className="grid-left-2">
                        <div className="liquid-staking" style={{ marginBottom: '20px' }}>
                            <p data-aos="fade-right" className="h3 " style={{ marginBottom: '5px', color: '#57645E' }}>
                                Liquid Staking
                            </p>
                            <span className="text-ls" data-aos="fade-right" data-aos-delay="300" style={{ color: '#838383' }}>
                        ...
                        <div className="money-market">
                            ...
                            <span className="text-mm" data-aos="fade-right" data-aos-delay="900" style={{ color: '#838383' }}>
                        ...
                        <div className="learn" data-aos="fade-right" data-aos-delay="1200" style={{ display: 'flex', placeItems: 'center', marginTop: '20px' }}>
                            <a
                ...
                <div className="grid-right" style={{ height: '100%', minHeight: '300px', width: '100%' }}>
                    <div className="grid-right-2" style={{ position: 'relative' }}>
                        <Image
                            data-aos="fade-left"
                        ...
                        <Image
                            ...
                            style={{ position: 'absolute', top: '100px', left: '40px', width: '60%', height: 'auto' }}
                        />
                    </div>
                </div>
            </div>
